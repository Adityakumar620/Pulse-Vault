    ...
    return ( 
        <div className="container">
            ...
            <div className="row p-5 mt-5 mb-5">
                <h1 className=' fs-2 text-center text-muted'>We pioneered the discount broking model in India. <br />Now, we are breaking ground with our technology.</h1>
            </div>

            <div className="row p-5 mt-5 border-top text-muted fs-5.5"style={{lineHeight:"2.0"}}>
